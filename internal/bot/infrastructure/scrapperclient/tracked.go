...
func (t *tracked) RegisterChat(ctx context.Context, chatID int64) error {
	if err := prometrics.ObserveOperationDuration(t.m.CommandDuration, prometrics.ScopeScrapperSync, "PostTgChatId", func() error {
...
func (t *tracked) AddLink(ctx context.Context, chatID int64, link string, tags []string) error {
	if err := prometrics.ObserveOperationDuration(t.m.CommandDuration, prometrics.ScopeScrapperSync, "PostLinks", func() error {
...
func (t *tracked) RemoveLink(ctx context.Context, chatID int64, link string) error {
	if err := prometrics.ObserveOperationDuration(t.m.CommandDuration, prometrics.ScopeScrapperSync, "DeleteLinks", func() error {
